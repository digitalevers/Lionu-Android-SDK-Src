...
import com.digitalevers.lionukt.interfaces.OppoIDInterface
 ...
 *
 */
class OppoDeviceIDHelper(private val mContext: Context) {
    var oaid: String = "OUID"
    private var sign: String? = null
    var oppoIDInterface: OppoIDInterface? = null
    ...
    private fun realoGetIds(str: String): String? {
        ...
        res = (oppoIDInterface as OppoIDInterface.up.down?)?.getSerID(pkgName, sign, str)
        return res
    }
    ...
    private val isSupportOppo: Boolean
        get() {
            var res = false
